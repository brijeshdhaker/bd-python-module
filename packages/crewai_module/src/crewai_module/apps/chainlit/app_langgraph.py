...
tools = [get_weather]
model = LLMManager.get_model(temperature=0)       # ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0)
final_model = LLMManager.get_model(temperature=0) # ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0)
