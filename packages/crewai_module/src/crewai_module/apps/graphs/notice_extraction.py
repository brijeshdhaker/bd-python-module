...
def parse_notice_message_node(state: WorkflowState) -> WorkflowState:
...
def check_escalation_status_node(state: WorkflowState) -> WorkflowState:
...
def answer_follow_up_question_node(state: WorkflowState) -> WorkflowState:
    """
...
def route_follow_up_edge(state: WorkflowState) -> str:
    """
...
def send_escalation_email_node(state: WorkflowState) -> WorkflowState:
    """
...
def create_legal_ticket_node(state: WorkflowState) -> WorkflowState:
...
def route_escalation_status_edge(state: WorkflowState) -> str:
    """
...
## conditional_edges
workflow.add_conditional_edges("check_escalation_status", route_escalation_status_edge,
    {
...
workflow.add_conditional_edges("create_legal_ticket",route_follow_up_edge,
    {
