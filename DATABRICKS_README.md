# bd_databricks_project

The 'bd_databricks_project' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/bd_databricks_project/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] bd_databricks_project_etl` to your workspace.
